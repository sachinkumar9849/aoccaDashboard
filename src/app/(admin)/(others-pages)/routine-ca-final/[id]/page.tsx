...
const UpdateClassPage = () => {
  ...
  const updateMutation = useMutation({
    ...
    onMutate: async () => {
      ...
      await queryClient.cancelQueries({ queryKey: ['routine-ca-final-list'] });

      // Snapshot the previous value
      const previousClasses = queryClient.getQueryData(['routine-ca-final-list']);
    ...
    onError: (error: Error, variables, context) => {
      ...
      if (context?.previousClasses) {
        queryClient.setQueryData(['routine-ca-final-list'], context.previousClasses);
      }
        ...
        <ComponentCard title="CA Intermediate routine update">
          <div className="grid grid-cols-2 gap-2">
            ...
            <div className="col-span-2 flex mt-3 gap-2">
              ...
              <button
                type="button"
                onClick={() => router.push("/routine-ca-final-list")}
