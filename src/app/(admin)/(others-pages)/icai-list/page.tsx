...
//     queryKey: ['icai-list'],
//     queryFn: () => apiClient.request<NewsBlog[]>('/toper-testimonial-team?type=icai&status=published')
//   });
...
//   return (
//     <div className="w-full p-4 bg-white rounded-lg shadow-sm">
//       <h2 className="text-lg font-normal mb-4">ICAI</h2>
...
//                       <Link href={`/icai/${item.id}`} className="p-1 text-blue-500 hover:text-blue-700" title="Edit">
//                         <Edit size={18} />
//                       </Link>
...
//   const { data, isLoading, isError, error } = useQuery<NewsBlog[]>({
//     queryKey: ['capiii-list'],
//     queryFn: () => apiClient.request<NewsBlog[]>('/toper-testimonial-team?type=cap-iii&status=published')
//   });
...
//                   <td className="py-3 px-6">
//                     <div className="flex gap-2">
//                       <Link href={`/capiii-list/${item.id}`} className="p-1 text-blue-500 hover:text-blue-700" title="Edit">
//                         <Edit size={18} />
//                       </Link>
//                         <button 
            ...
            {filteredItems && filteredItems.length > 0 ? (
              filteredItems.map((item) => (
                <tr key={item.id} className="border-b hover:bg-gray-50">
                  ...
                  <td className="py-3 px-6">
                    <div className="flex gap-2">
                      <Link href={`/icai-list/${item.id}`} className="p-1 text-blue-500 hover:text-blue-700" title="Edit">
                        <Edit size={18} />
                      </Link>
                      <button
                        className="p-1 text-red-500 hover:text-red-700"
